...
- [[ui-reference/01-communication/serial|Serial]] — 시리얼 케이블(RS-232/RS-485) 연결
- [[ui-reference/01-communication/tcp|TCP (Client / Server)]] — IP 기반 TCP/IP 연결
- [[ui-reference/01-communication/udp|UDP]] — 브로드캐스트·단방향 UDP 연결
- [[ui-reference/01-communication/ble|BLE]] — 블루투스 Low Energy (신기능)
- [[ui-reference/01-communication/mqtt|MQTT]] — MQTT 브로커 경유 원격 연결 (신기능)
- [[ui-reference/01-communication/dbnet|dbNet]] — 네트워크 자동 검색 도구
