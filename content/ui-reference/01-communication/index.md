...
- [Serial](/ui-reference/01-communication/serial) — 시리얼 케이블(RS-232/RS-485) 연결
- [TCP (Client / Server)](/ui-reference/01-communication/tcp) — IP 기반 TCP/IP 연결
- [UDP](/ui-reference/01-communication/udp) — 브로드캐스트·단방향 UDP 연결
- [BLE](/ui-reference/01-communication/ble) — 블루투스 Low Energy (신기능)
- [MQTT](/ui-reference/01-communication/mqtt) — MQTT 브로커 경유 원격 연결 (신기능)
- [dbNet](/ui-reference/01-communication/dbnet) — 네트워크 자동 검색 도구
