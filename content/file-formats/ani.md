...
> **ANI** — 여러 개의 [DAT](/file-formats/dat) 프레임을 **재생 순서·시간·효과**와 함께 묶은 애니메이션 파일. 전광판에서 움직이는 내용을 표출할 때 사용.
...
- 표준 GIF에서 변환 가능 — [GIF](/file-formats/gif) 참조

## 관련 파일 형식

- [DAT](/file-formats/dat) — ANI의 각 프레임이 내부적으로 DAT 형식
- [GIF](/file-formats/gif) — 표준 GIF, DabitOne에서 ANI로 변환해 전송
- [PLA](/file-formats/pla) — ANI 여러 개를 시간 스케줄에 묶음
