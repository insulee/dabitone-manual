...
> **ANI** — 여러 개의 [DAT](/docs/file-formats/dat) 프레임을 **재생 순서·시간·효과**와 함께 묶은 애니메이션 파일. 전광판에서 움직이는 내용을 표출할 때 사용.

## 어디서 만들어지나

| 편집 화면 | 결과물 |
|----------|--------|
| [GIF 편집](/docs/04-editor/gif) | `.ANI` — 프레임 타임라인 기반으로 제작 (**DabitOne 신규**) |
| [텍스트 편집](/docs/04-editor/text) 효과 | `.ANI` — 흐름·점멸 등 시간 효과가 적용된 텍스트 |
...
- 표준 GIF에서 변환 가능 — [GIF](/docs/file-formats/gif) 참조

## 관련 파일 형식

- [DAT](/docs/file-formats/dat) — ANI의 각 프레임이 내부적으로 DAT 형식
- [GIF](/docs/file-formats/gif) — 표준 GIF, DabitOne에서 ANI로 변환해 전송
- [PLA](/docs/file-formats/pla) — ANI 여러 개를 시간 스케줄에 묶음

## 체험

- [/quickstart/04-edit-image/](/quickstart/04-edit-image/) — 내장 GIF/ANI 편집기 체험
