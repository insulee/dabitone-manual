...
import quickLinksStyle from "./styles/quickLinks.scss"

interface QuickLinkItem {
  icon: "home" | "store" | "chat" | "mail" | "phone"
  label: string
  href: string
}
...
const icons: Record<string, string> = {
  ...
  chat: `<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22z"/></svg>`,
...
export default ((opts: QuickLinksOptions) => {
  const QuickLinks: QuartzComponent = ({ displayClass }: QuartzComponentProps) => {
    return (
        ...
        <ul>
          {opts.links.map((link) => (
            <li>
              ...
              >
                <span class="quick-link-icon" dangerouslySetInnerHTML={{ __html: icons[link.icon] }} />
  ...
  QuickLinks.css = quickLinksStyle
  return QuickLinks
