...
const tour: Tour = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: "반복·속도 설정",
      description:
        "애니메이션 반복 횟수(1회·무한·사용자 지정)와 재생 속도를 최종 결정합니다. 현장 LED 응답 속도와 보는 사람 가독성 균형이 중요.",
      image: EDITOR,
      srSummary:
        "반복 설정과 프레임 속도로 애니메이션 주기 조정. 너무 빠르면 눈이 따라가기 힘들고, 너무 느리면 정보 전달 지연.",
      tips: [
        "읽을 텍스트가 있으면 프레임당 1.5~3초",
        "로고·심볼 루프는 빠르게 (0.2~0.5초)",
        "무한 반복은 배경용, 일회성 메시지는 N회 지정",
      ],
    },
    {
      id: "step-verify",
      title: "현장 표출 확인",
      description:
        "전송 후 실제 전광판에서 애니메이션 재생을 확인합니다. 끊기거나 깜빡임이 있으면 프레임 수·속도를 낮춰 보세요.",
      image: EDITOR,
      srSummary:
        "현장 확인. 끊김·깜빡임은 보통 프레임 수 과다 또는 속도 과속. 프레임 줄이기·속도 낮추기로 해결.",
      tips: [
        "끊김: 프레임 당 표시 시간 늘림",
        "깜빡임: 배경·앞 배열 색 대비 조정",
      ],
